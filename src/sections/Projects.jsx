                ...
                <div className="projects-cta animate-on-scroll">
                    <div className="cta-card card">
                        ...
                        <div className="cta-buttons">
                            <a href="https://github.com/vaibhavkadusAL" target="_blank" rel="noopener noreferrer" className="btn btn-primary">
                            ...
                            <a href="mailto:vaibhavkadus31@gmail.com" className="btn btn-outline">
