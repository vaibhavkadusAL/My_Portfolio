...
const Footer = () => {
    ...
    const socialLinks = [
        {
            name: 'LinkedIn',
            url: 'https://www.linkedin.com/in/vaibhavkadus/',
            icon: (
        ...
        {
            name: 'GitHub',
            url: 'https://github.com/vaibhavkadusAL',
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="footer-container container">
                <div className="footer-content">
                    <div className="footer-section">
                        <h3 className="footer-title gradient-text">Vaibhav Kadus</h3>
                ...
                <div className="footer-bottom">
                    <p className="footer-copyright">
                        © {currentYear} Vaibhav Kadus. All rights reserved.
                    </p>
